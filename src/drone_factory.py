...
def create_drone(drone_type: str, position: List[float], heading: float) -> BaseDrone:
    ...
    Args:
        ...
        position: List containing [x, y] coordinates for the initial drone position
    ...
    Example:
        >>> quad = create_drone("quadcopter", [0.0, 0.0], 45.0)
        >>> wing = create_drone("fixedwing", [10.0, 20.0], 180.0)
    """
